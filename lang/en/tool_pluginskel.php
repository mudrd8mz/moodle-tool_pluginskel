...
$string['generate'] = 'Generate plugin';
$string['saverecipe'] = 'Save recipe';
$string['proceedmanually'] = 'Proceed with manual generation';
$string['proceedrecipefile'] = 'Proceed with recipe file';
$string['proceedrecipecontent'] = 'Proceed with recipe content';
$string['recipefile'] = 'Recipe file';
$string['recipecontent'] = 'Recipe';
$string['recipefilehdr'] = 'Generate the plugin from recipe file';
$string['recipecontenthdr'] = 'Generate the plugin from recipe';
...
$string['skelstrings'] = 'Strings';
$string['skelinstall'] = 'Install feature';
$string['skeluninstall'] = 'Uninstall feature';
$string['skelid'] = 'Id';
