...
$string['component_help'] = 'The full frankenstyle component name in the form of componenttype_componentname. If you want to change the component type please restart the plugin generation process from the beginning.';
$string['component_link'] = 'https://docs.moodle.org/dev/version.php';
$string['componenthdr'] = 'Component';
$string['componentname'] = 'Component name';
$string['componentname_help'] = 'The name of the plugin. This will become the name of the plugin\'s root folder. The name must start with a letter and ideally should contain letters only. Numbers and underscores are allowed, but discouraged. Activity modules must not have underscores in their name.';
...
$string['copyright_help'] = 'This field should contain the year the plugin was created, the name(s) of the copyright holder(s) as well as the email addresse(s). The copyright tag will be present in every file of the plugin as part of the standard Moodle boilerplate. For more information about the standard Moodle boilerplate click on the "More help" button.';
...
$string['dependencies_version_help'] = 'The version number for the plugin dependency. A value ANY_VERSION means that any version of the plugin will satisfy the dependency';
...
$string['recipe_help'] = 'The recipe should be written using the YAML serialization format. A recipe template is located in the plugin installation directory at cli/example.yaml. More information about the YAML syntax can be found by clicking the "More help" button which will take you the official YAML web page.';
$string['recipe_link'] = 'http://yaml.org/';
$string['recipefile'] = 'Recipe file';
$string['recipefile_help'] = 'The recipe should be written using the YAML serialization format. A recipe template is located in the plugin installation directory at cli/example.yaml. More information about the YAML syntax can be found by clicking the "More help" button which will take you the official YAML web page.';
